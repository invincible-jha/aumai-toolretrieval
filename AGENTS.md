# Agent Instructions for Toolretrieval

## Project Context
Toolretrieval is an open source Vector-indexed tool search for large tool registries.

## Repository Layout
- `src/aumai_toolretrieval/` — package source
